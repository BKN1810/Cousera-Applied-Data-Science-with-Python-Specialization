...
def answer_one():
    ...
    energy=pd.DataFrame(energy, columns=['Unnamed: 1','Petajoules','Gigajoules','%'])  
    ...
    column=['Country Name','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015']
    GDP= pd.DataFrame(GDP, columns=column)
    #print(len(GDP))    
    #####################################################################################################
    
    df = pd.merge(ScimEn, energy, how = 'inner', left_on = 'Country', right_on='Country')
    merge_df = pd.merge(df,GDP, how = 'inner', left_on = 'Country', right_on='Country Name')
...
def answer_two():
    ...
    mg1 = pd.merge(ScimEn,GDP,left_on='Country',right_on='Country',how='inner')
    mg2= pd.merge(ScimEn,energy,left_on='Country',right_on='Country',how='inner')
    mg3 = pd.merge(energy,GDP,left_on = 'Country',right_on='Country',how='inner')
    mgg= pd.merge(mg1,energy,left_on='Country',right_on='Country',how='inner')
    
    #####################################################################################################
    
    loss = energy.shape[0]+GDP.shape[0]+ScimEn.shape[0]-mg1.shape[0]-mg2.shape[0]-mg3.shape[0]
...
def answer_four():
    Top15 = answer_one()
    avgSortData=answer_three()
    sixth_gdp_country=avgSortData.index[5]
    #print(sixth_gdp_country)
    
    sixth_gdp_country_data = Top15.loc[sixth_gdp_country]
    #print(sixth_gdp_country_data)
    
    result = sixth_gdp_country_data['2015']-sixth_gdp_country_data['2006'] 
...
def answer_six():
    ...
    max_country_name=Top15['% Renewable'].argmax()
    
    #print(max_value)
    #print(max_country_name)
    
    return (max_country_name,max_value)     ###"ANSWER"
...
def answer_seven():
    ...
    max_country_name=Top15['ratio'].argmax()
    
    return (max_country_name,max_ratio)     ###"ANSWER"
...
def answer_eight():
    ...
    return Top15.irow(2).name  ###"ANSWER"
